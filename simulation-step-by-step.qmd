...
Here , we investigate on total 7 different fidelity pattern increases, 3 fast increases, 1 linear and 3 slow increases for this design setting.
...
Next for a slow increase (reflected by an exponential function):
...
For a fast increase (reflected by a logarithmic function):
...
The figure summarize the results of the several simulations for different fidelity patterns regarding power of the study.
