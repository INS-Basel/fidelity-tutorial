...
![Workflow diagramme of the simulation](img/workflow.png){#fig-workflow}
...
According the @fig-workflow corresponds to inner box, here we show how to evaluate the performance of a cluster randomized trial with one specific setting of study design and probably existing specific implementation error (fidelity pattern). 
