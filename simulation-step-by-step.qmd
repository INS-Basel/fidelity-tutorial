...
The descriptions follow along the steps outlined in @fig-workflow : 
...
Following @fig-workflow, we chose to evaluate the performance of a cluster randomized trial (Design choice) and with possible implementation error (fidelity pattern). 
...
For explanation see @sec-statsdetails.
